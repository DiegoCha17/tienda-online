...
export default function AdminProductForm() {
  ...
  const removeValueFromSpec = (specIndex: number, valIndex: number) => {
    const updated = [...specifications];
    updated[specIndex].values = updated[specIndex].values.filter(
      (_, i) => i !== valIndex,
    );
    setSpecifications(updated);
  };
  ...
  return (
    <div className="bg-white rounded-[2rem] p-8 mb-12 shadow-2xl shadow-gray-200/50 border border-gray-100 transition-all">
      <div className="flex items-center justify-between mb-10 border-b border-gray-50 pb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1 ml-14">
            Añade productos con múltiples imágenes y variaciones detalladas.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border-2 border-transparent focus:border-green-500 rounded-2xl px-6 py-4 text-gray-900 transition-all outline-none"
                />
                {errors.name && (
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-50 border-2 border-transparent focus:border-green-500 rounded-2xl px-6 py-4 text-gray-900 transition-all outline-none resize-none"
                />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border-2 border-transparent focus:border-green-500 rounded-2xl px-6 py-4 text-gray-900 transition-all outline-none font-mono"
                  />
                  {errors.price && (
                    <p className="text-red-500 text-xs mt-1 ml-1">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    {...register("category")}
                    className="w-full bg-gray-50 border-2 border-transparent focus:border-green-500 rounded-2xl px-6 py-4 text-gray-900 transition-all outline-none appearance-none cursor-pointer"
                  >
                    {categories.length === 0 ? (
          ...
          <section className="space-y-6 pt-4">
            ...
            <div className="bg-gray-50 p-6 rounded-[2rem] space-y-6 overflow-hidden">
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 bg-white border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-500"
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                ...
                <button
                  ...
                  className="bg-gray-900 text-white px-5 rounded-xl font-bold hover:scale-105 transition-transform"
                >
                  Añadir
                </button>
              </div>
              ...
              <div className="space-y-4">
                {specifications.map((spec, sIdx) => (
                  ...
                  >
                    <div className="flex justify-between items-center mb-4">
                      <span className="font-black text-gray-800 uppercase text-xs tracking-wider">
                        {spec.name}
                      </span>
                      <button
                        type="button"
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {spec.values.map((val, vIdx) => (
                        <span
                          key={vIdx}
                          className="bg-green-50 text-green-700 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-2 group"
                        >
                          {val}
                          <XCircle
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border-none rounded-lg px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-green-500/50"
                      onKeyPress={(e) => {
                        if (e.key === "Enter") {
                          e.preventDefault();
                          addValueToSpec(
                ...
                {specifications.length === 0 && (
                  <p className="text-center text-gray-400 text-sm py-4 italic">
                    No has añadido especificaciones adicionales.
                  </p>
                )}
              </div>
            </div>
          ...
          {/* Sección de Ficha Técnica (Ahora Descripción del Producto) */}
          <section className="space-y-6 pt-4">
            <h3 className="text-sm font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2">
              <LayoutGrid className="w-4 h-4" /> Descripción del Producto
            </h3>
            <div className="bg-gray-50 p-6 rounded-[2rem] space-y-4 overflow-hidden">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm outline-none focus:border-green-500"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-700 mb-1 ml-1">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm outline-none focus:border-green-500 resize-none"
                />
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {images.map((img, idx) => (
                <div
                  key={idx}
                  className="relative group aspect-square rounded-[2rem] overflow-hidden border-2 border-gray-100 shadow-sm"
                >
              ...
              <div className="relative aspect-square border-2 border-dashed border-gray-200 rounded-[2rem] flex flex-col items-center justify-center hover:bg-gray-50 transition-colors cursor-pointer group">
                <input
                  type="file"
                  accept="image/*"
                ...
                {uploadingImage ? (
                  ...
                  <>
                    ...
                    <span className="text-sm font-bold text-gray-400 group-hover:text-gray-600">
                      Añadir Imagen
                    </span>
                  </>
                )}
            ...
            <p className="text-xs text-gray-400 flex items-center gap-2 px-2 italic">
              <LayoutGrid className="w-3 h-3" /> La primera imagen será usada
              como miniatura en la tienda.
            </p>
          </section>
