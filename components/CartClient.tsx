...
export default function CartClient({ whatsappNumber }: CartClientProps) {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] py-12 px-4 sm:px-6 lg:px-8 transition-colors">
      {" "}
      <div className="max-w-6xl mx-auto">
        ...
        {cart.length === 0 ? (
          <div className="bg-gray-50 rounded-[2rem] shadow-sm p-16 text-center space-y-6 border border-gray-100 ">
            {" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {cart.map((item) => (
                <div
                  ...
                  className="bg-gray-50 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 p-5 sm:p-6 flex flex-col sm:flex-row gap-6 items-center border border-gray-100 transform hover:-translate-y-1"
                >
                  {" "}
                  <img
                    src={item.image_url}
                    alt={item.name}
                    className="w-32 h-32 rounded-2xl object-cover shadow-sm bg-gray-50 border border-gray-100 "
                  />{" "}
                  ...
                  <div className="flex flex-col items-center sm:items-end gap-5 min-w-[140px]">
                    ...
                    <div className="flex items-center gap-1 bg-gray-50 p-1.5 rounded-xl border border-gray-200">
                      ...
                      <button
                        ...
                        className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-gray-50 hover:shadow-sm transition-all text-gray-600 font-medium text-lg"
                      >
                        -
                      </button>{" "}
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        removeItem(item.cartItemId || item.id.toString())
                      }
            ...
            <div className="lg:col-span-1">
              {" "}
              <div className="bg-gray-50 rounded-[2rem] shadow-2xl shadow-indigo-500/5 p-8 border border-gray-100 sticky top-24">
                {" "}
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          {...register("name")}
                          className="w-full text-gray-900 placeholder-gray-400 border-gray-300 rounded-xl px-4 py-3 bg-gray-50 focus:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none border"
                      ...
                      <div>
                        ...
                        <textarea
                          {...register("address")}
                          rows={3}
                          className="w-full text-gray-900 placeholder-gray-400 border-gray-300 rounded-xl px-4 py-3 bg-gray-50 focus:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none border resize-none"
                    ...
                    <div className="pt-4 space-y-3">
                      ...
                      <button
                        ...
                        className="w-full bg-gray-50 text-gray-700 font-semibold px-4 py-3 rounded-xl border-2 border-gray-200 hover:bg-gray-50 transition-colors"
                      >
                        {" "}
                        Volver al carrito{" "}
                      </button>{" "}
